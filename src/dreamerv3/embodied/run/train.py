...
import embodied
import numpy as np
from dreamerv3.embodied.core.wrappers import print_step_info
...
def train(agent, env, replay, logger, args):
  ...
  def train_step(tran, worker):
    print_step_info(args, tran)  # MOD: Export the action space (keypresses, clicks...) as the AI plays in real time.
  ...
  while step < args.steps:
    print(f'Args: ', args)
    print(f'Start episode: {step} / {args.steps}')
